  ...
  return (
     <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div className="glass-effect rounded-2xl p-8 space-y-6">
        <h3 className="text-2xl font-bold text-white flex items-center gap-3"><Calculator className="text-emerald-400"/> Calculateur de Plan</h3>
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select id="type" name="type" value={form.type} onChange={handleChange} className="w-full mt-1 p-2 bg-white/5 border border-white/10 rounded-lg text-white text-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <div className="flex gap-2">
                        <select id="duree-select" name="duree" value={manualDuree ? 'manual' : form.duree} onChange={handleChange} className="w-full mt-1 p-2 bg-white/5 border border-white/10 rounded-lg text-white h-10 text-sm">
                ...
                <div>
                    ...
                    <select id="frequence" name="frequence" value={form.frequence} onChange={handleChange} className="w-full mt-1 p-2 bg-white/5 border border-white/10 rounded-lg text-white text-sm">
      ...
      {result && (
        <motion.div initial={{opacity:0, x:20}} animate={{opacity:1, x:0}} exit={{opacity:0, x:20}} className="glass-effect rounded-2xl p-8 bg-white/10 flex flex-col justify-center border border-emerald-500/30">
          <h3 className="text-2xl font-bold text-white mb-6">Votre Projection</h3>
          <div className="space-y-4 text-center">
              <div className="bg-white/5 p-4 rounded-lg border border-white/5">
                <p className="text-gray-400 text-sm capitalize">Dépôt {form.frequence} suggéré</p>
                <p className="font-bold text-3xl text-white">{result.depotPeriodique} {form.currency}</p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                            ...
                            return (
                                <motion.div key={plan.id} className="glass-effect rounded-2xl p-6 border border-white/5 relative overflow-hidden group">
                                    ...
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <div className="text-right">
                                            <p className="text-2xl font-bold text-white font-mono">{plan.balance.toLocaleString()} {plan.currency}</p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="pb-10">
                             ...
                             <div className="relative z-10">
                                ...
                                <div className="space-y-3 text-sm">
                                    ...
                                    <div className="flex justify-between border-b border-white/5 pb-2">
                                        ...
                                        <span className="text-white">{group.rate}%</span>
                                    </div>
                        ...
                        <div key={req.id} className="bg-slate-900/50 border border-slate-700 p-6 rounded-xl flex flex-col justify-between h-full">
                            <div>
                                <div className="flex justify-between items-start mb-2">
                                    <h4 className="font-semibold text-white">{req.groupName}</h4>
                ...
                {activeGroups.length === 0 && myRequests.length === 0 && (
                     <div className="glass-effect rounded-2xl p-12 text-center border border-white/5 border-dashed">
                        ...
                        <h3 className="text-xl font-bold text-white mb-2">Aucune adhésion active</h3>
